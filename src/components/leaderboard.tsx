...
const generateMockDonors = (count: number): Donor[] => {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    // Calculate donation amount (decreasing as rank increases)
    const totalDonated = Math.max(100, Math.round(5000 / Math.sqrt(i)))
...
// Generate 100 mock donors for demonstration
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-border/30">
                    ...
                    {currentDonors.map((donor) => {
                      const isCurrentUser = donor.walletAddress === currentUserWalletAddress
